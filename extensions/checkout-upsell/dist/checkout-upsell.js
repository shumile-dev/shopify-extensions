...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    const [discountCodeHasApplied, setDiscountCodeHasApplied] = (0, import_react12.useState)(false);
    const [hasFreeProduct, setHasFreeProduct] = (0, import_react12.useState)(false);
    ...
    function applyDiscount(threshold) {
      return __async(this, null, function* () {
        if (totalAmount.amount > threshold) {
          console.log("applying discount");
          yield applyDiscountChange({
            "code": "BFCM",
    ...
    function removeFreeGift() {
      return __async(this, null, function* () {
        const freeGiftCartLine = cartLines.find(
          (cartLine) => cartLine.attributes.some((attr) => attr.key === "type" && attr.value === "free-gift")
        );
        if (freeGiftCartLine) {
          try {
            yield changeCartLine({
    ...
    function addFreeGift(threshold) {
      return __async(this, null, function* () {
        const hasFreeGift = cartLines.some(
          (cartLine) => cartLine.attributes.some((attr) => attr.value === "free-gift")
        );
        if (!hasFreeGift) {
    ...
    if (discountCodes.length > 0) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "success", title: "Discount Code Applied" });
    } else {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "info", title: "No discount applied" });
    }
  }
})();
